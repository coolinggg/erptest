<?php /* Smarty version Smarty-3.1.11, created on 2013-03-17 11:44:43
         compiled from "I:\pgcoding\phproot\erptest\UI\tpl\kucun.html" */ ?>
<?php /*%%SmartyHeaderCode:641451453c2bba8ef2-39311855%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d8c2360761622739aa9c7d9d199216e8722d5fa' => 
    array (
      0 => 'I:\\pgcoding\\phproot\\erptest\\UI\\tpl\\kucun.html',
      1 => 1362891020,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '641451453c2bba8ef2-39311855',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_51453c2bcdc7a2_91633445',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51453c2bcdc7a2_91633445')) {function content_51453c2bcdc7a2_91633445($_smarty_tpl) {?><!DOCTYPE html>
...
<link id="favicon" href="favicon.ico" rel="icon" type="image/x-icon" />
    ...
    <script type="text/javascript" src="UI/widget/tab/jquery.jerichotab.js"></script>
    ...
    $().ready(function() {
      ...
      $.fn.jTreeList({ renderTo:'#menu',
        treeData: [{ 'name':'库存管理', 'nodes':[
                    { 'name':'库存列表', 'link':'jModelCrud-kucun','linktype':'jModelCrud' },
                    { 'name':'物理管理','link':'#sample-button','linktype':'formtag' }
        ] }
        ]
    });
var treeMenuData={  };

treeMenuData['jModelCrud-kucun'] = { uiTableModelName: "kucun",uiDialogFormModelName: "kucun",uiFormModelName: "kucun" };
            ...
            <div class="container-fluid">
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        ...
                        <li class="active"><a href="?index=kucun"><i class="icon-gift"></i>库存管理</a></li>
